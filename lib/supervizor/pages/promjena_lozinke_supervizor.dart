...
class PromjenaLozinkePage extends StatefulWidget {
  ...
  @override
  _PromjenaLozinkePageState createState() => _PromjenaLozinkePageState();
}

class _PromjenaLozinkePageState extends State<PromjenaLozinkePage> {
  String unosEmail = '',
      unosLozinka = '',
      novaLozinka = '',
      novaLozinkaPotvrda = '';
